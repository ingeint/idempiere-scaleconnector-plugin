...
public class ViewClientMode extends JFrame {
    ...
    public ViewClientMode() {
        ...
        pnlScaleParameters.add(lblSerialPort, "width 25%");
        pnlScaleParameters.add(txtSerialPort, "width 75%, span 3, wrap");

        pnlScaleParameters.add(lblReadings, "width 25%");
        pnlScaleParameters.add(txtReadings, "width 25%");
        pnlScaleParameters.add(lblByteCount, "width 25%");
        pnlScaleParameters.add(txtByteCount, "width 25%, wrap");
