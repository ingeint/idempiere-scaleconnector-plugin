...
public class X_SC_Scale extends PO implements I_SC_Scale, I_Persistent {
	...
	public X_SC_Scale(Properties ctx, int SC_Scale_ID, String trxName) {
		...
		/**
		 * if (SC_Scale_ID == 0) { setBaud (0); setByteCount (0); setDataBits (0);
		 * setEndCharacter (0); setName (null); setParity (0); setReadings (0); // 1
		 * setSC_Scale_ID (0); setSC_ServerSettings_ID (0); setSerialPort (null);
		 * setStartCharacter (0); setStopBits (0); setValue (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_SC_Scale[").append(get_ID()).append("]");
		return sb.toString();
	}
	...
	public com.ingeint.model.I_SC_ServerSettings getSC_ServerSettings() throws RuntimeException {
		return (com.ingeint.model.I_SC_ServerSettings) MTable
				.get(getCtx(), com.ingeint.model.I_SC_ServerSettings.Table_Name)
