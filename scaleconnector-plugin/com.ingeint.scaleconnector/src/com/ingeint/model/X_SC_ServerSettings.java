...
public class X_SC_ServerSettings extends PO implements I_SC_ServerSettings, I_Persistent {
	...
	public X_SC_ServerSettings(Properties ctx, int SC_ServerSettings_ID, String trxName) {
		...
		/**
		 * if (SC_ServerSettings_ID == 0) { setHostAddress (null); setHostPort (0);
		 * setSC_ServerSettings_ID (0); setSecondsTimeout (0); setValue (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_SC_ServerSettings[").append(get_ID()).append("]");
		return sb.toString();
	}
